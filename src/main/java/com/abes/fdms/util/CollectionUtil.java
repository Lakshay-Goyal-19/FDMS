...
public class CollectionUtil {
    ...
    static {
        ...
        deliveryPersons.put("DeliveryPerson1", new DeliveryPersonDto("Manu", "Manu", "manu@gmail.com", "9000000001"));
        deliveryPersons.put("DeliveryPerson2", new DeliveryPersonDto("Tanmay", "Tanmay", "tanmay@gmail.com", "9000000002"));
